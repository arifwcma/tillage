...
CURVE_CSV_PATH = PROJECT_ROOT / "results" / "probe_kenya_rbnd_full_batch_lr1e5_curve.csv"
OUTPUT_FIGURE_PATH = PROJECT_ROOT / "results" / "probe_kenya_rbnd_full_batch_lr1e5_test_rmse.png"
...
def main():
    ...
    figure.suptitle(
        "RBND test RMSE — Kenya / none (FULL-batch=195, lr=1e-5, dropout=0.3, seed=42)"
    )
