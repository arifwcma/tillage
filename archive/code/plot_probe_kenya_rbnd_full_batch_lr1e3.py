...
CURVE_CSV_PATH = PROJECT_ROOT / "results" / "probe_kenya_rbnd_full_batch_lr1e3_curve.csv"
OUTPUT_FIGURE_PATH = PROJECT_ROOT / "results" / "probe_kenya_rbnd_full_batch_lr1e3_test_rmse.png"
...
def annotate_best_test_epoch(ax, best_epoch, best_test_rmse):
    ...
    ax.annotate(
        ...
        xytext=(best_epoch - 700, best_test_rmse + 0.25),
...
def main():
    ...
    figure.suptitle(
        "RBND test RMSE — Kenya / none (FULL-batch=195, lr=1e-3, dropout=0.3, seed=42)"
    )
